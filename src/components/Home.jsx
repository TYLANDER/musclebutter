  ...
  render() {
    return (<div>
      ...
      <div className="section definition">
        <div className="container">
          <div className="row">
            ...
            <p className="section-description">A state of equilibrium between strength-stability and fluidity-flexibility. Today’s technology has helped us gain incredible intellect and new information, but our potential to connect with our body’s grace and innate awareness is waning.</p>
            <p className="section-description">At Muscle Butter, we assist in reclaiming areas of the body lost to postural habits, pain, tension, and trauma through massage and movement re-education. Our studio is a large bright space dedicated to one individual at a time. Services include manual therapy sessions, self care classes, and core integration training sessions.</p>
          </div>
        </div>
      </div>
      ...
      <div className="section evidence-based-massage">
        <div className="container">
          <div className="row">
            <img className="cover" src={require('../assets/Massage_Hold_16x9.png')} alt="Smiley Face"/>
          </div>
          <div className="row">
      ...
      <div className="section have-a-goal">
        <div className="container">
          <div className="row">
            ...
            <p className="section-description">Remember why you started and what you set out to achieve with your practitioner(s). Alex works hard to help you achieve these goals which is why she does not work alone. If necessary, she often refers out to sports medicine doctors, doctors of physical therapy, other bodyworkers, specialized pilates instructors, strength and conditioning specialists, cognitive behavioral therapists, and pelvic floor specialists.
            </p>
          </div>
          <div className="row">
            <h3 className="section-heading">Have a question?</h3>
            <p className="section-description">Contacting me by email is the best way to start a conversation. From there, we schedule a call if necessary. I look forward to hearing from you!
            </p>
          </div>
        </div>
      </div>
